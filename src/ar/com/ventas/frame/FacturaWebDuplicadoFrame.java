 ...
 * @author Mario
 */
public class FacturaWebDuplicadoFrame extends javax.swing.JFrame {
    ...
    private IvaVentas fc1 = null;
    private List<RenglonFactura> renglFc = null;
...
//    private final String order_name;
     ...
     */
    public FacturaWebDuplicadoFrame() {
...
//        this.order_num = order_num;
        ...
        try {
            ...
            fc1 = new IvaVentasService().getIvaVentasById(6L);
        } catch (Exception ex) {
            Logger.getLogger(FacturaWebDuplicadoFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        clienteFactura = fc1.getCliente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacturaWebDuplicadoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacturaWebDuplicadoFrame().setVisible(true);
            }
        });
    }
    ...
    private void generarFactura() {
        ...
        clienteFacturaPapel = fc1.getCliente().getRazonSocial();
...
//        }
    ...
    private void calcularTotales() {
        ...
        for (RenglonFactura renFa : renglFc) {
    ...
    private void cargarDatos() {
        codigoTxt.setText(fc1.getCliente().getCodigo());
        razonSocialTxt.setText(fc1.getCliente().getRazonSocial());
        try {
            renglFc = new RenglonFacturaService().getAllRenglonFacturaFromIvaVentas(fc1);
        } catch (Exception ex) {
            Logger.getLogger(FacturaWebDuplicadoFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (renglFc != null && !renglFc.isEmpty()) {
            DefaultTableModel tbl = (DefaultTableModel) tablaFactura.getModel();
            for (RenglonFactura rf : renglFc) {
                Object ob[] = new Object[10];
                ob[0] = rf.getProducto().getCodigo();
                ob[1] = rf.getCantidad().toString();
                ob[2] = rf.getDescripcion();
                precioFinal = rint(((rf.getProducto().getPrecio() * (1 + (porcentualIva / 100))) + rf.getProducto().getImpuesto()) * 100) / 100;
                ob[3] = df.format(precioFinal);
