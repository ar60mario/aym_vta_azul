 ...
 * @author Mario
 */
public class NotaCreditoWebDeFacturaCopyFrame extends javax.swing.JFrame {
...
//    private final String order_name;
     ...
     * @param fac
     */
    public NotaCreditoWebDeFacturaCopyFrame(Cliente cli, IvaVentas fac) {
...
//      levanto el modelo creado del frame
    ...
    private void bloquearCliente() {
        ...
        try {
            ...
            Logger.getLogger(NotaCreditoWebDeFacturaCopyFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        ct.setTraba1(true);
        cuTr.setTraba2(true);
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotaCreditoWebDeFacturaCopyFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotaCreditoWebDeFacturaCopyFrame(null, null).setVisible(true);
            }
        });
    }
...
//            System.out.println(internos);
                ...
                String td_f = factura.getCodigoTipoDoc().toString();
                String pv = "5";
