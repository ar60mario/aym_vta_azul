...
//    }
    public File armarFcA(Cliente cli, IvaVentas iv, List<RenglonFactura> rf) throws FileNotFoundException, DocumentException, Exception {
        ...
        tieneDto = false;
        if (iv.getPorcentualDescuentoGlobal() != null) {
...
//        JOptionPane.showMessageDialog(null, System.getProperty("user.dir"));
        ...
        PdfWriter writer = PdfWriter.getInstance(pdf, ficheroPdf);
        writer.setInitialLeading(20);
//        JOptionPane.showMessageDialog(null, "voy a abrir el pdf");
//        JOptionPane.showMessageDialog(null, ficheroPdf);
        // ABRO EL DOCUMENTO
        pdf.open();
//        JOptionPane.showMessageDialog(null, "ya lo abri");
        // INICIO ENCABEZADO FACTURA
        String cod = " 1";;
        String fex = sdf.format(iv.getFecha());
        String nro = "A_"
...
//            pdf.add(new Paragraph("ESPACIO EN BLANCO", FontFactory.getFont("arial", 8, PLAIN, FONDO_BLANCO)));
        ...
        pdf.add(pie2Fc);
//        JOptionPane.showMessageDialog(null, "c://qr//CodigoQR" + nr0 + ".png");
//        JOptionPane.showMessageDialog(null, "c://qr//afip.png");
//        JOptionPane.showMessageDialog(null, System.getProperty("user.dir"));
...
//        pieFc8.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
    ...
    public File armarNdA2(Cliente cli, IvaVentas iv, List<RenglonFactura> rf) throws FileNotFoundException, DocumentException, Exception {
        String nr0 = dfn.format(iv.getNumeroFactura());
        String fileNameFormatted = getFileNameFormatted2(iv);
        Document pdf = new Document();
        Rectangle hojaA4 = new Rectangle((float) 690, (float) 990);//890
...
//            pdf.add(new Paragraph("ESPACIO EN BLANCO", FontFactory.getFont("arial", 8, PLAIN, FONDO_BLANCO)));
    ...
    public File armarNdB2(Cliente cli, IvaVentas iv, List<RenglonFactura> rf) throws FileNotFoundException, DocumentException, Exception {
        String nr0 = dfn.format(iv.getNumeroFactura());
