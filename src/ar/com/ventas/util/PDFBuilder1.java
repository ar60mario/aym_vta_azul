...
public class PDFBuilder1 {
    ...
    private final DecimalFormat dfd = new DecimalFormat("#0.0");
    ...
    private String getFileNameFormatted2(IvaVentas cons) {
        String filename = "c://pdf//fc_"
                + "A" + dfn.format(cons.getNumeroFactura())
                + "_" + sdff.format(cons.getFecha()) + ".pdf";
        return filename;
    }
    ...
    private String getFileNameFormatted3(IvaVentas cons) {
        String filename = "c://pdf//fc_"
                + "B" + dfn.format(cons.getNumeroFactura())
                + "_" + sdff.format(cons.getFecha()) + ".pdf";
        return filename;
    }
    ...
    public File armarFcA(Cliente cli, IvaVentas iv, List<RenglonFactura> rf) throws FileNotFoundException, DocumentException, Exception {
        ...
        Boolean tieneDescuento = iv.getCliente().getTieneDescuento();
...
//            pdf.add(new Paragraph("ESPACIO EN BLANCO", FontFactory.getFont("arial", 8, PLAIN, FONDO_BLANCO)));
        ...
        if (tieneDescuento) {
            if (importeDescuento > 0.00) {
                ...
                pieToFc2 = new PdfPCell(new Paragraph("DESC. " + dfd.format(porcentajeDescuento), FontFactory.getFont("arial", 9, Font.PLAIN, NEGRO)));
        ...
        String tpd = "80"; // porque es fc A
        //tpd = iv.getCliente().getTipo().toString();
